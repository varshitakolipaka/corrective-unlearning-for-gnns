...
def parse_args():
    ...
    parser.add_argument('--attack_type', type=str, default='label', help='attack type', choices=["label", "edge", "random", "trigger", 'label_strong', 'metattack'])
    ...
    parser.add_argument('--frac_test', type=bool, default=False, help='whether to evaluate on CPU')
    parser.add_argument('--frac_test_filename', type=str, default="./report.txt", help='whether to evaluate on CPU')
